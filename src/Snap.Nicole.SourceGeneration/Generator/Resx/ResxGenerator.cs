...
using static Snap.Nicole.SourceGeneration.Primitive.SyntaxKeywords;

namespace Snap.Nicole.SourceGeneration.Generator.Resx;

[Generator]
public sealed class ResxGenerator : IIncrementalGenerator
{
    private static readonly DiagnosticDescriptor InvalidPropertiesForNamespace = new("SN401", "Couldn't compute namespace", "Couldn't compute namespace for file '{0}'", "ResxGenerator", DiagnosticSeverity.Warning, true);
    private static readonly DiagnosticDescriptor InvalidPropertiesForResourceName = new("SN402", "Couldn't compute resource name", "Couldn't compute resource name for file '{0}'", "ResxGenerator", DiagnosticSeverity.Warning, true);
    private static readonly DiagnosticDescriptor NameShouldNotEndsWithFormat = new("SN403", "Resource data name should not ends with 'Format'", "Resource data '{0}' should not ends with 'Format'", "ResxGenerator", DiagnosticSeverity.Warning, true);
