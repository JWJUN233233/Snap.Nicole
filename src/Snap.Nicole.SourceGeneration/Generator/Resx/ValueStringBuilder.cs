...
internal ref struct ValueStringBuilder
{
    ...
    public readonly int Capacity { get => chars.Length; }
    ...
    public readonly Span<char> RawChars { get => chars; }
    ...
    {
        return chars.Slice(start, pos - start);
    }
